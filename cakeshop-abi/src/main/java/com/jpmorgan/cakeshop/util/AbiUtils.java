...
public class AbiUtils
{
	 ...
	 * @return
	 */
	public static BigInteger toTimestamp(String key, Map<String, Object> blockData)
	{
		String str = (String) blockData.get(key);
		if (str == null)
		{
		...
		long raw = str.startsWith("0x") ? Long.valueOf(str.substring(2), 16) : Long.valueOf(str, 16);
		return BigInteger.valueOf(TimeUnit.NANOSECONDS.toSeconds(raw));
	}
