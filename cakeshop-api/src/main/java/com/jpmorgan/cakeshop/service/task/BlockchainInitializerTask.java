...
public class BlockchainInitializerTask implements Runnable
{
	...
	private void deployContractRegistry()
	{
		...
		String regAddr = findSharedNetworkConfig();
	 ...
	 */
	private String findSharedNetworkConfig()
	{
		...
		{
			LOG.error("Error loading CAKESHOP_SHARED_CONFIG at " + fSharedConfig.toString() + ": " + e.getMessage(), e);
			return null;
		}
